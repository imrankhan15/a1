<%@ Page Language="C#" AutoEventWireup="true" CodeFile="create new clerk.aspx.cs" Inherits="create_new_clerk" %>
...
<asp:Image ID="Image1" runat="server" ImageUrl="~/Images/fig8.jpg" Height="150px" 
        ...
        <span class="style2">create new clerk</span><br style="font-size: xx-large" />
  
    
        <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/Default.aspx" CssClass="sdfs">Logout</asp:HyperLink>
    
        <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="~/admintasks.aspx">AdminHome</asp:HyperLink>
        <br />
       ...
       <br />
        ...
        <br />
         <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            InsertCommand="INSERT INTO &quot;CREATENEWCLERK&quot; ( &quot;ID&quot;, &quot;PASSWORD&quot;, &quot;FIRSTNAME&quot;, &quot;LASTNAME&quot;, &quot;DATEOFBIRTH&quot;, &quot;ADDRESS&quot;, &quot;NATIONALITY&quot;, &quot;OCCUPATION&quot;, &quot;HOBBY&quot;) VALUES (:iid, :ppass, :fname, :lname, TO_DATE(:dob), :address, :nation, :occup, :hobby)"
            >
           <InsertParameters>
